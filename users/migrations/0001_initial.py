# Generated by Django 4.0.8 on 2023-01-21 21:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[('Support', 'پشتیبانی'), ('Complains', 'شکایات'), ('Suggestions', 'انتقادات و پیشنهادات')], default='Suggestions', max_length=30)),
